...
buildPythonApplication rec {
  ...
  propagatedBuildInputs = [ dateutil lockfile dogpile-cache jinja2 pytz requests click taskw future responses typing-extensions pydantic email-validator tomli pygobject3];
